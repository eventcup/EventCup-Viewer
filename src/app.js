...
class App {
  ...
  cameraPosition: hash.cameraPosition ? hash.cameraPosition.split(',').map(Number) : null,
    ...
    // Spinner initial verstecken (sofern vorhanden)
    if (this.spinnerEl) {
      this.hideSpinner();
    }
  ...
  createViewer() {
    ...
    if (this.dropEl) {
      // Dropzone-Inhalt löschen und durch Viewer ersetzen
      this.dropEl.innerHTML = '';
      this.dropEl.appendChild(this.viewerEl);
    } else {
      // Fallback: direkt in body hängen
   ...
   * (Wird aktuell nicht mehr benutzt, bleibt aber zur Sicherheit erhalten.)
